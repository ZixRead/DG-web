...
?>	
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						<div class="container-xxl d-flex flex-grow-1 flex-stack">
							<div class="d-flex align-items-center me-5">
								...
								<a href="home">
									<img alt="Logo" class="logo-rotate" src="<?php echo $website['image']; ?>" />
								</a>
							</div>
      ...
      <div class="fb-customerchat"
		...
		logged_out_greeting="<?php echo $website['logged_in_greeting']; ?>">
	  	...
	  	<!-- filepath: c:\xampp\htdocs\template\navbar.php -->
	<style>
	.emoji {
	  color: #fff;
	  font-size: 20px;
...
<style>
/* Animation for rotating from left to right */
@keyframes rotateYFromLeft {
  0% {
...
.logo-rotate {
  animation: rotateYFromLeft 5s linear infinite; /* Rotate continuously */
  ...
  transform-origin: center; /* Rotate around the center */
		...
		<div class="emojis">
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/4151/4151154.png" alt="Songkran1" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/7662/7662635.png" alt="Songkran2" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/4042/4042319.png" alt="Songkran3" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/706/706164.png" alt="Songkran4" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/3048/3048393.png" alt="Songkran5" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/3127/3127972.png" alt="Songkran6" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/3523/3523063.png" alt="Songkran7" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/4446/4446230.png" alt="Songkran8" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/9044/9044785.png" alt="Songkran9" style="width:20px;"></h6>
  </div>
  <div class="emoji">
    <h6><img src="https://cdn-icons-png.flaticon.com/512/4151/4151155.png" alt="Songkran10" style="width:20px;"></h6>
  </div>
</div>
