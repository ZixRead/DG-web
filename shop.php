                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                foreach($result as $row) {
                                    ...
                                    $stock_text = $stock_count > 0 ? "$stock_count $lang[instock]" : "⛔ สินค้าหมดแล้ว 📦";
                                    $stock_button_text = $stock_count > 0 ? "<i class='fas fa-shopping-cart text-white'></i> $lang[purchase] ฿$product_price" : $lang['outofstock'];
                                    $stock_button = $stock_count > 0 ? "" : "disabled";
                                    $stock_button_disabled = $stock_count > 0 ? "btn btn-lg w-100 btn-bg-primary text-white" : "btn btn-lg w-100 mb-5 btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger disabled";
